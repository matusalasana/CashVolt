const AboutDevelopers = () => {
  return (
    <div className="max-w-5xl mx-auto px-6 py-12 text-base-content">
      ...
      <p className="mb-6 text-base leading-relaxed text-base-content/80">
      ...
      <div className="grid md:grid-cols-2 gap-6">
        ...
        <div className="card bg-base-200 shadow-md">
          <div className="card-body">
            ...
            <p className="text-sm leading-relaxed text-base-content/80 mt-3">
        ...
        <div className="card bg-base-200 shadow-md">
          <div className="card-body">
            ...
            <ul className="list-disc ml-6 mt-3 text-sm space-y-1 text-base-content/80">
      ...
      {/* SYSTEM ARCHITECTURE */}
      <div className="mt-10 card bg-base-200 shadow-md">
        <div className="card-body">
          <h2 className="text-xl font-semibold">
          ...
          <ul className="list-disc ml-6 text-sm space-y-1 text-base-content/80">
          ...
          <p className="text-sm mt-4 text-base-content/80">
