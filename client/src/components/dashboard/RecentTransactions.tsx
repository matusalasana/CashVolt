...
const RecentTransactions = () => {
  ...
  return (
    <div className="bg-base-200 dark:bg-base-300 p-4 sm:p-2 rounded-2xl shadow-md hover:shadow-lg transition-all duration-300 overflow-hidden">
  ...
  <div className="space-y-3">
    {transactions?.length > 0 ? (
      transactions.map((tx) => (
        <div
          key={tx.id}
          className="bg-base-100 dark:bg-base-200 rounded-xl
