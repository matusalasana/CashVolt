  ...
  if (isLoading){
    return (
      <RectangularLoadingSkeleton 
        amount={5} 
        height="h-35"
        style="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 md:gap-5 p-0"
      />
    );
  }

  return (
    <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 md:gap-5 p-0">
